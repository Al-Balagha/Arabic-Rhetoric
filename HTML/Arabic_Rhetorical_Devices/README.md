...
This folder contains the taxonomy of Arabic rhetorical devices in self-contained, standalone HTML format, divided into 4 domains:
* [A-Sentence_Construction_and_Syntactical_Stylistics_(ilm_ul_maani)](A-Sentence_Construction_and_Syntactical_Stylistics_(ilm_ul_maani))
* [B-Figurative_Speech_(ilm_ul_bayaan)](B-Figurative_Speech_(ilm_ul_bayaan))
* [C-Linguistic_Embellishments_(ilm-ul-badi)](C-Linguistic_Embellishments_(ilm-ul-badi))
* [D-Negative_Rhetorical_Effects](D-Negative_Rhetorical_Effects)
