...
This folder contains the taxonomy of Arabic rhetorical devices in PDF format.

The folder structure is as follows:  

* [Encyclopedia_of_Arabic_Rhetoric.pdf](Encyclopedia_of_Arabic_Rhetoric.pdf) - the encyclopedia homepage  
* README.md - this file  
* [Arabic_Rhetorical_Devices](Arabic_Rhetorical_Devices) - a folder containing the taxonomy in the form of PDF files
* [Supporting_Pages](Supporting_Pages) - a folder containing PDF files giving background information about Arabic rhetoric and the Encyclopedia. It also contains a glossary of commonly used terms.
