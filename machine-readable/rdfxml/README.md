...
&nbsp;
## ℹ️ JSON-LD files
This folder contains the **RDF/XML exports** of all Arabic rhetorical devices and taxonomy items included in **Arabic Rhetorical Device Taxonomy (v0.1.1)**.

* Each file (`Qxx.rdf`) corresponds to one Arabic rhetorical device or taxonomy item as RDF/XML.
* Each file (`Qxx.ttl`) is exported directly from [**BalaghaBase.org**](https://balaghabase.org) (custom Wikibase instance). 
* This is the most widely supported RDF format (W3C standard).  
* Suitable for ingestion into: Protégé, Jena, Virtuoso, Stardog, GraphDB.  
* Files follow the `schema:` vocabulary; structure mirrors the JSON-LD exports.  
* For human-friendly TTL or web-native JSON-LD, please see adjacent folders.
