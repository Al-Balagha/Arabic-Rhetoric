...
This folder contains self-contained, standalone HTML files giving background information about Arabic rhetoric and the Encyclopedia. It also contains a [glossary](glossary) of commonly used terms.
